...
<div class="wrap rooms-list">
    ...
    <table class="wp-list-table widefat fixed striped table-view-list posts">
        ...
        <tr>
            ...
            <th scope="col"
                class="manage-column column-categories"><?php echo __( "Moderator Password", "plugnmeet" ) ?>
            ...
            <th scope="col" class="manage-column column-categories"><?php echo __( "Actions", "plugnmeet" ) ?>
            </th>
        </tr>
        </thead>
