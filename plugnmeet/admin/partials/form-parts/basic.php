...
<table class="form-table" role="presentation">
    ...
    <?php if (isset($_GET['id'])): ?>
        <tr>
            ...
            <td><input name="room_id" type="text" size="40" value="<?php echo $fields_values['room_id']; ?>"
                       disabled><input name="room_id" type="text" size="40"
                                       value="[plugnmeet_room_view id='<?php echo $fields_values['id']; ?>']"
                                       disabled>
            </td>
        </tr>
    <?php endif; ?>
    <tr>
        ...
        <td><input required="required" name="room_title"
                   type="text" size="40" value="<?php echo $fields_values['room_title']; ?>"></td>
    </tr>
    <tr>
